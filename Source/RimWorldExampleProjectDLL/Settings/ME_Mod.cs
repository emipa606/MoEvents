...
internal class ME_Mod : Mod
{
    ...
    public ME_Mod(ModContentPack content) : base(content)
    {
        ...
        currentVersion =
            VersionFromManifest.GetVersionFromModMetaData(ModLister.GetActiveModWithIdentifier("Mlie.MoEvents"));
    }
    ...
    public override void DoSettingsWindowContents(Rect rect)
    {
        ...
        if (currentVersion != null)
        {
            ...
            listing_Standard.Label("MO_Version".Translate(currentVersion));
