...
public class MOIncidentWorker_PodCrashTribal : IncidentWorker
{
    ...
    private readonly LetterDef NewQuest = DefDatabase<LetterDef>.GetNamedSilentFail("NewQuest");
    ...
    protected override bool TryExecuteWorker(IncidentParms parms)
    {
        ...
        Find.LetterStack.ReceiveLetter(text, text2, NewQuest, new TargetInfo(intVec, map));
