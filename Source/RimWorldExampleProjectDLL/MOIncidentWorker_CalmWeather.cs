...
public class MOIncidentWorker_CalmWeather : IncidentWorker
{
    protected override bool TryExecuteWorker(IncidentParms parms)
    {
        ...
        Find.LetterStack.ReceiveLetter("MO_CalmWeather".Translate(), "MO_CalmWeatherDesc".Translate(),
            LetterDefOf.NegativeEvent); //"The weather just got remarkably calm. Wind turbines will be useless, but shooting will be easier."
        return true;
    }
}